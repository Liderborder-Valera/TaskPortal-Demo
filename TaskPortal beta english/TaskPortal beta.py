...
taskmng = Button(text="Task manager", command=startmng)
...
startrg = Button(text="Registry Editor", command=startrgf)
startrg.place(y=0, x=105)

startxplr = Button(text="Explorer", command=startxplrb)
